...
List<Version?> fromGraphQLListCursorNullableToDartListVersionNullable(
    ...
    v
        .map(
            (e) => fromGraphQLCursorNullableToDartVersionNullable(e as String?))
        .toList();
...
List<Version?>?
    fromGraphQLListNullableCursorNullableToDartListNullableVersionNullable(
        ...
        v
            ?.map((e) =>
                fromGraphQLCursorNullableToDartVersionNullable(e as String?))
            .toList();
List<String?>?
...
List<GameTitle?> fromGraphQLListNovelTitleNullableToDartListGameTitleNullable(
    ...
    v
        .map((e) =>
            fromGraphQLNovelTitleNullableToDartGameTitleNullable(e as String?))
        .toList();
...
List<GameTitle?>?
    fromGraphQLListNullableNovelTitleNullableToDartListNullableGameTitleNullable(
            List<Object?>? v) =>
        v
            ?.map((e) => fromGraphQLNovelTitleNullableToDartGameTitleNullable(
                e as String?))
            .toList();
List<String?>?
    fromDartListNullableGameTitleNullableToGraphQLListNullableNovelTitleNullable(
        ...
        v
            ?.map(
                (e) => fromDartGameTitleNullableToGraphQLNovelTitleNullable(e))
            .toList();
